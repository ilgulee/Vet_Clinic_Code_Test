package ilgulee.com.asurionvetcliniccodetest.network
...
class NetworkModule(private val listener: OnDownloadComplete) : AsyncTask<String, Void, String>() {
        ...
        try {
            ...
            val errorMessage = when (e) {
                ...
                is SecurityException -> {
                    ...
                    "doInBackgroun: Security Exception, Check permission! ${e.message}"
                }
                else -> {
